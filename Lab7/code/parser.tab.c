...
static const yytype_int8 yyrhs[] =
{
      ...
      18,     9,    17,    10,    -1,    17,     3,    17,    -1,    17,
       4,    17,    -1,    17,     5,    17,    -1,    17,     6,    17,
      -1,    11,    17,    12,    -1,     8,    -1,     7,    -1,     7,
      -1
};
...
{
       0,    13,     0,     2,     4,     0,     1,     3,     0,    12,
      11,     0,     0,     0,     0,     0,     0,     0,     5,    10,
       6,     7,     8,     9
};
...
{
       5,    -4,     8,    -4,     5,    13,    -4,    -4,    10,    -4,
      -4,    10,     1,    -3,    10,    10,    10,    10,    -4,    -4,
      14,    14,    -4,    -4
};
...
{
      14,    15,    16,    17,    14,    15,    16,    17,     6,    19,
      13,    18,     1,    20,    21,    22,    23,     9,    10,    16,
      17,    11,     8,     7
};

static const yytype_uint8 yycheck[] =
{
       3,     4,     5,     6,     3,     4,     5,     6,     0,    12,
      11,    10,     7,    14,    15,    16,    17,     7,     8,     5,
       6,    11,     9,     4
};
...
{
       0,     7,    14,    15,    16,    18,     0,    15,     9,     7,
       8,    11,    17,    17,     3,     4,     5,     6,    10,    12,
      17,    17,    17,    17
};
...
#line 65 "parser.y"
    {
start_ptr = (yyvsp[(1) - (1)].start_expr);
;}
    break;
...
#line 69 "parser.y"
    {
struct start_node* curr = (yyvsp[(1) - (2)].start_expr);
;}
    break;
...
#line 73 "parser.y"
    {
    (yyval.start_expr) =(yyvsp[(1) - (1)].start_expr);
    (yyval.start_expr) = curr;
;}
    break;
...
struct start_node *curr = create_start_node(); curr->left = (yyvsp[(1) - (4)].sub_expr);
curr->right = (yyvsp[(3) - (4)].sub_expr);
(yyval.start_expr) = curr;
;}
    break;
...
/* Line 1455 of yacc.c  */
#line 89 "parser.y"
    { struct node* curr = make_node('+'); curr->left = (yyvsp[(1) - (3)].sub_expr);
curr->right = (yyvsp[(3) - (3)].sub_expr);
(yyval.sub_expr) = curr;
;}
    break;
...
curr->left = (yyvsp[(1) - (3)].sub_expr); curr->right = (yyvsp[(3) - (3)].sub_expr);
(yyval.sub_expr) = curr;
;}
    break;
...
/* Line 1455 of yacc.c  */
#line 110 "parser.y"
    {(yyval.sub_expr) = (yyvsp[(2) - (3)].sub_expr);;}
    break;
...
#line 112 "parser.y"
    {
    struct node* curr = make_node((char)(yyvsp[(1) - (1)].symbol));
    (yyval.sub_expr) = curr;
;}
    break;
